  ...
  return (
    <div className="search-overlay" onClick={onClose}>
      <div className="search-overlay-inner" onClick={e => e.stopPropagation()}>
        <input autoFocus className="search-overlay-input" placeholder="Search..." type="text" />
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <h2 className="modal-title">Top Companies</h2>
          ...
          {companies.map(company => (
            <div className="modal-company-card" key={company.id}>
              ...
              <div className="modal-company-info">
                ...
                <p>{company.sector || "Company"}</p>
                <span>{company.students_applied ?? 0} Applications</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="companies-section" id="companies" ref={companiesRef} data-section="companies">
        ...
        <div className="companies-grid">
          {loadingCompanies ? (
            ...
            <div className="empty-placeholder">No companies at the moment.</div>
          ) : (
              ...
              <div className="company-card" key={company.id}>
                ...
                <div className="company-info-zone">
                  ...
                  <div className="company-meta-row">
                    <div className="rep-block"><span className="rep-icon">👤</span><div><span className="rep-name">Recruiter</span><span className="rep-label">Contact</span></div></div>
                    <div className="internship-info"><strong>{company.students_applied ?? 0}</strong> Applications</div>
                  </div>
                  <div className="stars-row"><Stars n={4} /><button className="see-details-btn">See All <ArrowRight /></button></div>
                </div>
              </div>
            ))
          )}
