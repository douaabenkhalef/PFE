...
// DetailsModal component (identique à l'original)
  ...
  const fetchApplications = async () => {
    ...
    try {
      ...
      if (validatedData.success) {
        ...
        // 🔥 Séparer les conventions validées en deux catégories : signées vs non signées
        const signed = [];
        const notSigned = [];
      ...
      <div className="ml-64 flex-1 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {permissionError && (
            <div className="flex items-center gap-3 bg-orange-500/10 backdrop-blur-lg border border-orange-500/30 rounded-xl p-4 mb-6">
              ...
              <div>
                ...
                <p className="text-orange-400/60 text-xs mt-1">💡 Veuillez contacter votre supérieur pour demander les permissions nécessaires.</p>
              </div>
            </div>
          )}
          ...
          <div className="mb-8">
            ...
            <p className="text-white/60">Gérez les conventions de stage en attente de validation, prêtes à signer et déjà signées</p>
          </div>
          ...
          <div className="flex gap-2 mb-6 border-b border-white/20 pb-2">
            ...
            >
              Prêtes à signer ({counts.validated})
            </button>
            <button
          ...
          {/* Applications Table */}
          {loading ? (
            <div className="flex items-center justify-center py-24 text-white/50"><Loader2 size={24} className="animate-spin mr-3" /> Chargement des conventions...</div>
            ...
            <div className="bg-white/5 rounded-xl p-16 text-center border border-white/10">
              ...
              <p className="text-white/50">
                {activeTab === 'pending' ? 'Aucune convention en attente de validation.' : 
                 activeTab === 'validated' ? 'Aucune convention prête à signer.' : 
