...
const CompanyManagerDashboard = () => {
  ...
  useEffect(() => {
    ...
    // 🔥 Supprimé l'observation de teamRef
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="sd-main">
        ...
        {/* 🔥 Supprimé tout le section Team Members */}
